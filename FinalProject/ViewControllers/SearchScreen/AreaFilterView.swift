...
//  FinalProject
//
//  Created by ThanDuc on 27/07/2023.
//

import UIKit

class AreaFilterView: UIView {
    ...
    override func awakeFromNib() {
        ...
        lb1.text = "Dưới 20 m\u{00B2}"
        lb2.text = "20 m\u{00B2} - 30 m\u{00B2}"
        lb3.text = "30 m\u{00B2} - 40 m\u{00B2}"
        lb4.text = "40 m\u{00B2} - 60 m\u{00B2}"
        lb5.text = "Trên 60 m\u{00B2}"
